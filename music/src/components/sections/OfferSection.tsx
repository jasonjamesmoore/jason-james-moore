...
export default function OfferSection({ id }: SectionProps) {
  return (
    <section
      id={id}
      className="py-20 px-6 md:px-12 bg-gradient-to-b from-indigo-100 via-rose-100 to-white text-black"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-neutral-300">
