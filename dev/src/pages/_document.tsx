  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:url" content="https://dev.jasonjamesmoore.com" />
        ...
        />
        <meta property="og:image" content="https://dev.jasonjamesmoore.com/og-image.jpg" />
        
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://dev.jasonjamesmoore.com" />
        <meta name="twitter:title" content="Jason Moore - Full-Stack Developer" />
        <meta
          name="twitter:description"
          content="Full-stack portfolio featuring production subscription management system (Stripe + Next.js) and interactive music theory platform. Case studies with React 19, TypeScript 5, Next.js 16."
        />
        <meta name="twitter:image" content="https://dev.jasonjamesmoore.com/og-image.jpg" />
